...
#define TRANSLATION_H
    ...
    static const TranslationEntry translationTable[] = {
        ...
        { "Enable Display 2 (CS2)", "Display 2 (CS2) aktivieren", "Activer l&#39;&eacute;cran 2 (CS2)" },
        { "Enables chip-select control for Display 2, a second identical display wired to CS2 (GPIO 18) - requires a restart to take effect", "Aktiviert die Chip-Select-Steuerung f&uuml;r Display 2, ein zweites baugleiches Display am CS2-Pin (GPIO 18) - ein Neustart ist erforderlich, damit die &Auml;nderung wirksam wird", "Active le contr&ocirc;le chip-select pour l&#39;&eacute;cran 2, un second &eacute;cran identique c&acirc;bl&eacute; sur CS2 (GPIO 18) - un red&eacute;marrage est n&eacute;cessaire pour appliquer le changement" },
        { "Rotation (Display 2 / CS2)", "Rotation (Display 2 / CS2)", "Rotation (&eacute;cran 2 / CS2)" },
        { "Rotates Display 2's (CS2) clock face independently of Display 1 - only relevant when Display 2 is enabled above", "Dreht das Zifferblatt von Display 2 (CS2) unabh&auml;ngig von Display 1 - nur relevant, wenn Display 2 oben aktiviert ist", "Fait pivoter le cadran de l&#39;&eacute;cran 2 (CS2) ind&eacute;pendamment de l&#39;&eacute;cran 1 - pertinent uniquement si l&#39;&eacute;cran 2 est activ&eacute; ci-dessus" },
