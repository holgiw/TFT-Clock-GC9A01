...
#define TRANSLATION_H
    ...
    static const TranslationEntry translationTable[] = {
        ...
        { "The minute hand moves smoothly instead of jumping in 1-minute steps", "Der Minutenzeiger bewegt sich gleichm&auml;&szlig;ig, statt in 1-Minuten-Schritten zu springen", "L'aiguille des minutes se d&eacute;place en douceur au lieu de sauter par pas d'une minute" },
